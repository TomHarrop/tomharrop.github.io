...
\definefontfamily [mainface] [tt] [Inconsolata LGC]
...
\dontleavehmode%
\gotobox{\framed{%
  \externalfigure[img/GitHub-Mark][height=4ex]}}[url(gh)]%
\hskip1.5em%
\gotobox{\framed{%
  \externalfigure[img/In-2C-CMYK-2in-TM][height=4ex]}}[url(li)]%
\hskip1.5em%
\gotobox{\framed{%
  \externalfigure[img/so-icon.eps][height=4ex]}}[url(so)]
